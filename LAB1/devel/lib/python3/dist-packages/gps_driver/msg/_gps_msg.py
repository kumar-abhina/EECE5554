...
class gps_msg(genpy.Message):
  _md5sum = "b607ce52934453464cf338d8e362925c"
...
"""
  ...
  _slot_types = ['std_msgs/Header','float64','float64','float64','float64','float64','int16','string']
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_5dh().pack(_x.Latitude, _x.Longitude, _x.Altitude, _x.UTM_easting, _x.UTM_northing, _x.Zone))
      _x = self.Letter
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.Latitude, _x.Longitude, _x.Altitude, _x.UTM_easting, _x.UTM_northing, _x.Zone,) = _get_struct_5dh().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
