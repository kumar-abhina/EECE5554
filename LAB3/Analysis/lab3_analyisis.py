# -*- coding: utf-8 -*-
"""lab3_analyisis.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/14lI-KjoSA1q7qg-JKT9rouud8XfkWjv-
"""
...
for string in LocationD_z:
    ...
    if dots == 1:
      LocationD_z_new.append(float(string))
    elif dots == 2:
      LocationD_z_new.append(float(string[4:]))
...
(t222, addd, addde, adddn) = allantools.adev(np.array(LocationD_z_new), rate=r, data_type="freq", taus="decade")
...
plt.title("Allan Deviation (Gyro)")
plt.grid(True)
plt.legend()
plt.show()
...
plt.plot(time[:719860],LocationD_z_new,label = "Gyro_z")
plt.xlabel('Time(sec)')
